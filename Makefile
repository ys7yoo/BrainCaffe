...
DYNAMIC_VERSION_REVISION 	:= 0-Brain
...
#MATLAB_CXXFLAGS := $(CXXFLAGS) -Wno-uninitialized  -I$(MATLAB_DIR)/include -L$(MATLAB_DIR)/extern/lib
# in OSX I need extern folder!
MATLAB_CXXFLAGS := $(CXXFLAGS) -Wno-uninitialized  -I$(MATLAB_DIR)/extern/include -L$(MATLAB_DIR)/extern/lib
# MATLAB_LDFLAGS := $(LDFLAGS) -lmex -lmat
MATLAB_LDFLAGS := -lmex -lmat
...
$(MAT$(PROJECT)_SO): $(MAT$(PROJECT)_SRC) $(STATIC_NAME)
	...
	$(Q)$(MATLAB_DIR)/bin/mex $(MAT$(PROJECT)_SRC) \
			...
			CXXLIBS="\$$CXXLIBS $(STATIC_LINK_COMMAND) $(LDFLAGS) $(MATLAB_LDFLAGS)" -output $@
